---
title: "Utah DWQ Lake Profile Dashboard - User Guide"
...
Source code and additional information for this application are available via the [DWQ irTools GitHub repository](https://github.com/utah-dwq/irTools/).
This application is available under an [MIT license](https://github.com/utah-dwq/irTools/blob/master/LICENSE) .  
<br>
